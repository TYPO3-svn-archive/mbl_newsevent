...
$EM_CONF[$_EXTKEY] = array(
	'title' => 'News Event',
	'description' => 'Adds event information to news articles (tt_news). Event information can be downloaded to calendars through an iCalendar (.ics) feed. Not 100% compatible with tt_news. Please read the manual!',
	'category' => 'plugin',
	'shy' => 0,
